...
def create_rfm_df(df):
    ...
    recent_date = orders_df["order_purchase_timestamp"].dt.date.max() # ada yang salah aisdmslcmeskdjlmkjds
...
for column in datetime_columns:
    all_df[column] = pd.to_datetime(all_df[column],format="%Y-%m-%d %H:%M:%S")
...
st.header('E-Commerce Dashboard :moneybag:',divider='rainbow')



tab1, tab2, tab3 = st.tabs(["Pemesanan Harian", "Produk Terbaik dan Terburuk", "Pelanggan Terbaik"])
 
with tab1:
    st.subheader('Pemesanan Harian')
...
with tab2:
    ...
    st.subheader("Produk Terbaik dan Terburuk Berdasarkan Jumlah Pemesanan")
    ...
    ax[0].set_title("Produk dengan Peforma Terbaik", loc="center", fontsize=50)
    ...
    ax[1].set_title("Produk dengan Peforma Terburuk", loc="center", fontsize=50)
...
with tab3:
    ...
    with col1:
        ...
        st.metric("Rata-Rata Pelanggan terbaru (Hari)", value=avg_recency)
    ...
    with col3:
        ...
        st.metric("Rata-Rata Keuangan", value=avg_frequency)
    ...
    ax[0].set_title("Berdasarkan Terbaru (Hari)", loc="center", fontsize=50)
    ...
    ax[1].set_title("Berdasarkan Frekuensi", loc="center", fontsize=50)
    ...
    ax[2].set_title("Berdasarkan Keuangan", loc="center", fontsize=50)
